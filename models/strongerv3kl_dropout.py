...
class StrongerV3KL_Dropout(nn.Module):
    def __init__(self,cfg):
        ...
        self.headslarge=nn.Sequential(OrderedDict([
            ('conv0',conv_bn_dropout(self.outC[0],512,kernel=1,stride=1,padding=0)),
            ('conv1', sepconv_bn_dropout(512, 1024, kernel=3, stride=1, padding=1,seprelu=cfg.seprelu)),
            ('conv2', conv_bn_dropout(1024, 512, kernel=1,stride=1,padding=0)),
            ('conv3', sepconv_bn_dropout(512, 1024, kernel=3, stride=1, padding=1,seprelu=cfg.seprelu)),
            ('conv4', conv_bn_dropout(1024, 512, kernel=1,stride=1,padding=0)),
        ]))
        ...
        self.headsmid=nn.Sequential(OrderedDict([
            ('conv8',conv_bn_dropout(self.outC[1]+256,256,kernel=1,stride=1,padding=0)),
            ('conv9', sepconv_bn_dropout(256, 512, kernel=3, stride=1, padding=1,seprelu=cfg.seprelu)),
            ('conv10', conv_bn_dropout(512, 256, kernel=1,stride=1,padding=0)),
            ('conv11', sepconv_bn_dropout(256, 512, kernel=3, stride=1, padding=1,seprelu=cfg.seprelu)),
            ('conv12', conv_bn_dropout(512, 256, kernel=1,stride=1,padding=0)),
        ]))
        ...
        self.headsmall=nn.Sequential(OrderedDict([
            ('conv16',conv_bn_dropout(self.outC[2]+128,128,kernel=1,stride=1,padding=0)),
            ('conv17', sepconv_bn_dropout(128, 256, kernel=3, stride=1, padding=1,seprelu=cfg.seprelu)),
            ('conv18', conv_bn_dropout(256, 128, kernel=1,stride=1,padding=0)),
            ('conv19', sepconv_bn_dropout(128, 256, kernel=3, stride=1, padding=1,seprelu=cfg.seprelu)),
            ('conv20', conv_bn_dropout(256, 128, kernel=1,stride=1,padding=0)),
        ]))
